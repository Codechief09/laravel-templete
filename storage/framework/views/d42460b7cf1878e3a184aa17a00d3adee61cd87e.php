...
<aside class="app-sidebar"> 
    ...
    <ul class="side-menu app-sidebar3">
        ...
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'user|subscriber')): ?>
            <?php if(config('settings.smart_editor_feature_user') == 'allow'): ?>
                <li class="slide">
                    ...
                    <span class="side-menu__label"><?php echo e(__('Smart Editor')); ?></span><span class="text-primary fs-9 side-menu__new">New</span></a>
                </li> 
            <?php endif; ?>
        <?php endif; ?>
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin')): ?>
        ...
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'user|subscriber')): ?>
            <?php if(config('settings.rewriter_feature_user') == 'allow'): ?>
                <li class="slide">
                    ...
                    <span class="side-menu__label"><?php echo e(__('AI ReWriter')); ?></span><span class="text-primary fs-9 side-menu__new">New</span></a>
                </li> 
            <?php endif; ?>
        <?php endif; ?>
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin')): ?>
        ...
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'user|subscriber')): ?>
            <?php if(config('settings.chat_web_feature_user') == 'allow'): ?>
                <li class="slide">
                    ...
                    <span class="side-menu__label"><?php echo e(__('AI Web Chat')); ?></span><span class="text-primary fs-9 side-menu__new"><?php echo e(__('New')); ?></span></a>
                </li> 
            <?php endif; ?>
        <?php endif; ?>
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin')): ?>
        ...
        <?php endif; ?>
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'user|subscriber')): ?>
            <?php if(config('settings.chat_pdf_feature_user') == 'allow'): ?>
                <li class="slide">
                    <a class="side-menu__item" href="<?php echo e(route('user.chat.pdf')); ?>">
                    <span class="side-menu__icon lead-3 fs-18 fa-solid fa-file-pdf"></span>
                    <span class="side-menu__label"><?php echo e(__('AI Chat PDF')); ?></span><span class="text-primary fs-9 side-menu__new"><?php echo e(__('New')); ?></span></a>
                </li> 
            <?php endif; ?>
        <?php endif; ?>
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin')): ?>
        ...
        <?php endif; ?>
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'user|subscriber')): ?>
            <?php if(config('settings.chat_csv_feature_user') == 'allow'): ?>
                <li class="slide">
                    <a class="side-menu__item" href="<?php echo e(route('user.chat.csv')); ?>">
                    <span class="side-menu__icon lead-3 fs-18 fa-solid fa-file-csv"></span>
                    <span class="side-menu__label"><?php echo e(__('AI Chat CSV')); ?></span><span class="text-primary fs-9 side-menu__new"><?php echo e(__('New')); ?></span></a>
                </li> 
            <?php endif; ?>
        <?php endif; ?>
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin')): ?>
        ...
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'user|subscriber')): ?>
            <?php if(config('settings.chat_image_feature_user') == 'allow'): ?>
                <li class="slide">
                    ...
                    <span class="side-menu__label"><?php echo e(__('AI Chat Image')); ?></span><span class="text-primary fs-9 side-menu__new"><?php echo e(__('New')); ?></span></a>
                </li> 
            <?php endif; ?>
        <?php endif; ?>
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin')): ?>
        ...
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'user|subscriber')): ?>
            <?php if(config('settings.vision_feature_user') == 'allow'): ?>
                <li class="slide">
                    ...
                    <span class="side-menu__label"><?php echo e(__('AI Vision')); ?></span><span class="text-primary fs-9 side-menu__new"><?php echo e(__('New')); ?></span></a>
                </li> 
            <?php endif; ?>
        <?php endif; ?>
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin')): ?>
...
<!-- END SIDE MENU BAR --><?php /**PATH D:\openaidavinci-4.1\resources\views/layouts/nav-aside.blade.php ENDPATH**/ ?>