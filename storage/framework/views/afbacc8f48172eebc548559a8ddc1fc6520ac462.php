						...
						<?php if($internet): ?>
							<div class="form-group" style="padding:15px 0 0 20px">
								<label class="custom-switch mb-0">
									...
									<span class="custom-switch-description"><?php echo e(__('Toggle Button')); ?></span>
								</label>
							</div>
						<?php endif; ?>
					<?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\openaidavinci-4.1\resources\views/user/chat/view.blade.php ENDPATH**/ ?>