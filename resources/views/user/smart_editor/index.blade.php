	...
	<div class="col-md-12 smart-article-wrapper pl-0 pr-0">
		<div class="row no-gutters justify-content-center">
			<div class="col-sm-12 col-md-12 col-lg-2 responsive-left-column" id="left-tools-top-box">
				<div id="main-templates-container" class="app-sidebar responsive-left-column">
						...
						<div class="main-templates-title">
							...
							<a href="#" id="hide-left-menu"><i class="fa-solid fa-list-check"></i></a>
						</div>
			...
			<div class="col-sm-12 col-md-12 col-lg-7">	
				<a href="#" id="show-left-menu"><i class="fa-solid fa-list-check"></i></a>			
				<a href="#" id="show-right-menu"><i class="fa-sharp fa-solid fa-sliders"></i></a>			
			...
			<div class="col-sm-12 col-md-12 col-lg-2 responsive-right-column" id="right-tools-top-box">				
				<div class="meta-container responsive-right-column" >
					<div class="form-group">
						<a href="#" id="hide-right-menu"><i class="fa-sharp fa-solid fa-sliders"></i></a>	
...
<script type="text/javascript">
	...
	$('#show-right-menu').on('click', function() {
		...
		$('.meta-container').toggleClass('responsive-right-column');
		$('.meta-container').toggleClass('show-menu-width');
	});
