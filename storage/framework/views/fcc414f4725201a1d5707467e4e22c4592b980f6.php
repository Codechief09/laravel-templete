	...
	<form id="openai-form" action="" method="GET" enctype="multipart/form-data" class="mt-24">		
		...
		<div class="row justify-content-md-center">	
			<div class="col-sm-12 text-center">
				...
				<h6 class="mb-0 fs-12 text-muted"><?php echo e($chat->description); ?></h6>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\openaidavinci-4.1\resources\views/user/vision/index.blade.php ENDPATH**/ ?>